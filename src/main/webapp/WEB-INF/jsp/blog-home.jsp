  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 post-list blog-post-list">
        <div class="single-post"> <img class="img-fluid" src="img/blog/p1.jpg"
            ...
            <div class="user-details row align-items-center">
              ...
              <div class="social-wrap col-lg-6">
                <ul>
                  ...
                  <li><a href="#"><i class="fa fa-behance"></i></a><br>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div class="single-post"> <img class="img-fluid" src="img/blog/p2.jpg"
        ...
        <div class="single-post"> <img class="img-fluid" src="img/blog/p3.jpg"
        ...
        <div class="single-post"> <img class="img-fluid" src="img/blog/p4.jpg"
      ...
      <div class="col-lg-4 sidebar">
        <div class="single-widget search-widget">
          <form class="example" action="#" style="margin:auto;max-width:300px">
            <input placeholder="Search Posts" name="search2" type="text"> <button

                  type="submit"><i class="fa fa-search"></i></button> </form>
        </div>
        <div class="single-widget protfolio-widget"> <img src="img/blog/user2.jpg"

                                                          alt=""> <a href="#">
          <h4>Mrs. Rathnayaka</h4>
        </a>
          <p> MCSE boot camps have its supporters and its detractors. Some
            people do not understand why you should have to spend money on
            boot camp when you can get. </p>
          <ul>
            <li><a href="#"><i class="fa fa-facebook"></i></a><br>
            </li>
            <li><a href="#"><i class="fa fa-twitter"></i></a><br>
        ...
        <div class="single-widget recent-posts-widget">
          ...
          <div class="blog-list ">
            <div class="single-recent-post d-flex flex-row">
              <div class="recent-thumb"> <img class="img-fluid" src="img/blog/r1.jpg"

                                              alt=""> </div>
              <div class="recent-details"> <a href="blog-single.html">
            ...
            <div class="single-recent-post d-flex flex-row">
              <div class="recent-thumb"> <img class="img-fluid" src="img/blog/r2.jpg"
            ...
            <div class="single-recent-post d-flex flex-row">
              <div class="recent-thumb"> <img class="img-fluid" src="img/blog/r3.jpg"
            ...
            <div class="single-recent-post d-flex flex-row">
              <div class="recent-thumb"> <img class="img-fluid" src="img/blog/r4.jpg"
